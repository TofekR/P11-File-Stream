...
class MainFrameBase : public wxFrame
{
	...
	protected:
		...
		virtual void tombol_baca( wxCommandEvent& event ) { event.Skip(); }
		virtual void tombol_tulis( wxCommandEvent& event ) { event.Skip(); }
		virtual void tombol_bacatulis( wxCommandEvent& event ) { event.Skip(); }
